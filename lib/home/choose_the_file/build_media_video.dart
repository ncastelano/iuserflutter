...
class BuildMediaVideo extends StatefulWidget {
  const BuildMediaVideo({Key? key}) : super(key: key);

  @override
  State<BuildMediaVideo> createState() => _BuildMediaVideoState();
}

class _BuildMediaVideoState extends State<BuildMediaVideo> with AutomaticKeepAliveClientMixin {
  late Future<List<AssetEntity>> _futureVideos;
  ...
  void initState() {
    super.initState();
    _futureVideos = _loadAllAssetsOfType(RequestType.video);
