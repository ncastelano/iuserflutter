...
class StoreUpload extends StatefulWidget {
  @override
  _StoreUploadState createState() => _StoreUploadState();
}

class _StoreUploadState extends State<StoreUpload> {
  ...
  double? _latitude;
  double? _longitude;
  final String _selectedPostType = 'store'; // Fixado como 'store'
...
// Adicione o postID ao documento do usuário
      await FirebaseFirestore.instance.collection("users").doc(user.uid).update({
        'storePostID': videoID,  // Campo para armazenar o postID da loja
      });
