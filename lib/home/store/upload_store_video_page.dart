...
class UploadStoreVideoPage extends StatefulWidget {
  @override
  _UploadStoreVideoPageState createState() => _UploadStoreVideoPageState();
}

class _UploadStoreVideoPageState extends State<UploadStoreVideoPage> {
  ...
  double? _latitude;
  double? _longitude;
  String? _selectedPostType; // Pode ser: 'store', 'flash', 'product', 'place'
  ...
  Widget _buildThumbnailSelector() {
    return Column(
      children: [
        ...
        SwitchListTile(
          value: _selectedPostType == 'store',
          onChanged: (value) {
            setState(() {
              _selectedPostType = value ? 'store' : null;
            });
          },
          title: Text("É uma loja?"),
        ),
        SwitchListTile(
          value: _selectedPostType == 'flash',
          onChanged: (value) {
            setState(() {
              _selectedPostType = value ? 'flash' : null;
            });
          },
          title: Text("É um flash?"),
        ),
        SwitchListTile(
          value: _selectedPostType == 'product',
          onChanged: (value) {
            setState(() {
              _selectedPostType = value ? 'product' : null;
            });
          },
          title: Text("É um produto?"),
        ),
        SwitchListTile(
          value: _selectedPostType == 'place',
          onChanged: (value) {
            setState(() {
              _selectedPostType = value ? 'place' : null;
            });
          },
          title: Text("É um local?"),
        ),
