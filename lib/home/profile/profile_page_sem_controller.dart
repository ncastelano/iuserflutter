...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> followOrUnfollow(String uid) async {
    ...
    if (updatedFollowList.contains(currentUserID)) {
      await FirebaseFirestore.instance.collection("users").doc(uid).update({
        "followList": FieldValue.arrayRemove([currentUserID]),
      });
      setState(() {
      ...
      await FirebaseFirestore.instance.collection("users").doc(uid).update({
        "followList": FieldValue.arrayUnion([currentUserID]),
      });
      setState(() {
                    ...
                    children: [
                      ...
                      StreamBuilder<DocumentSnapshot>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          int followersCount = profileData['followList']?.length ?? 0;
                            ...
                            return GridView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return GestureDetector(
                                  onTap: () {
                                    // Adicione ação quando um item for clicado
                                  },
                                  child: Card(
