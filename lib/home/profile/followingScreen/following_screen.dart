...
class _FollowingScreenState extends State<FollowingScreen>
{
  ...
  Widget buildImage(String urlImage) => ClipRRect(
    ...
    child: Image.network(urlImage, fit: BoxFit.cover, width: 30, height: 30),
  );
              ...
              child: InkWell(
                onTap: ()
                {
                  Get.to(ProfileScreen(
                    ...
                    profileImage: followingUsersDataList[index]["image"],
                  ));
                },
                child: ListTile(
                  leading: Hero(
                    tag: followingUsersDataList[index]["image"],
                    child: buildImage(followingUsersDataList[index]["image"]),
                  ),
                  title: Text(
