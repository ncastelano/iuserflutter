...
class VideoPlayerFollowingsScreen extends StatefulWidget {
  final String videoUrl;
  final String thumbnailUrl;
  final void Function(CustomVideoPlayerController)? onControllerReady;

  const VideoPlayerFollowingsScreen({
  ...
  @override
  State<VideoPlayerFollowingsScreen> createState() => _VideoPlayerFollowingsScreenState();
}

class _VideoPlayerFollowingsScreenState extends State<VideoPlayerFollowingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      if (!_controller.isInitialized.value || !_controller.controller.value.isInitialized) {
        return Hero(
          tag: widget.thumbnailUrl+"following",
          child: Image.network(
            widget.thumbnailUrl,
            fit: BoxFit.cover,
