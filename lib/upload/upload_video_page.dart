...
class _UploadVideoPageState extends State<UploadVideoPage> {
  ...
  void _showSnackBar(String message) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: Colors.black, // fundo vermelho
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Upload de Vídeo'), elevation: 0),
    ...
    return Column(
      children: [
        ...
        SwitchListTile(
          ...
          subtitle: Text(
            "Se ativado, o vídeo será exibido no mapa com sua localização atual.",
          ),
        ),
      ],
    );
          ...
          children: [
            ...
            InkWell(
              ...
              child: Row(
                children: [
                  Icon(
                    _showTagField ? Icons.remove : Icons.add,
                    color: Colors.blue,
                  ),
                  SizedBox(width: 8),
                  Text(
                    _showTagField ? "REMOVER TAGS" : "ADICIONAR TAGS",
